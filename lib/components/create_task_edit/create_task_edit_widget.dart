...
class _CreateTaskEditWidgetState extends State<CreateTaskEditWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.itemDoc!.itemText);
    _model.textController2 ??=
        TextEditingController(text: widget.itemDoc!.moreText);
  }
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'CREATE_TASK_EDIT_COMP_UPDATE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_backend_call');

                                    final itemUpdateData = createItemRecordData(
                                      itemText: widget.itemDoc!.itemText,
                                      moreText: widget.itemDoc!.moreText,
                                      timestamp: widget.itemDoc!.timestamp,
                                    );
