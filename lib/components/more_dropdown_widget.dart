                      ...
                      await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => DetailsWidget(
                            ...
                            primary: valueOrDefault<Color>(
                              widget.item!.stable.colorPalettes.primaryColor,
                              FlutterFlowTheme.of(context).primary,
                            ),
                            contrasting: valueOrDefault<Color>(
                              widget
                ...
                child: Builder(
                  builder: (context) => InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'MORE_DROPDOWN_COMP_replaceWidget_ON_TAP');
                      logFirebaseEvent('replaceWidget_share');
                      await Share.share(
                        functions.getImageStringFromPath(valueOrDefault<String>(
