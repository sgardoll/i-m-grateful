...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<StylesRecord>>(
      stream: queryStylesRecord(
        queryBuilder: (stylesRecord) => stylesRecord.orderBy('style'),
      ),
                                      ...
                                      child: Material(
                                        ...
                                        child: Container(
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'REGISTER_PAGE_google_ICN_ON_TAP');
                                              logFirebaseEvent(
                                                  'IconButton_auth');
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                    ...
                                    child: Material(
                                      ...
                                      child: Container(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'REGISTER_PAGE_apple_ICN_ON_TAP');
