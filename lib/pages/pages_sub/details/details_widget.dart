  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ItemRecord>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FFAppState().bodyTextColor,
          body: Stack(
            children: [
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                        ...
                        color: valueOrDefault<Color>(
                          Theme.of(context).brightness == Brightness.light
                              ? valueOrDefault<Color>(
                                  detailsItemRecord
                                      .stable.colorPalettes.lightVibrant,
                                  FlutterFlowTheme.of(context).white,
                                )
                              : valueOrDefault<Color>(
                                  detailsItemRecord
                                      .stable.colorPalettes.darkVibrant,
                                  Colors.black,
                                ),
                                ...
                                .override(
                                  ...
                                  color: valueOrDefault<Color>(
                                    Theme.of(context).brightness ==
                                            Brightness.light
                                        ? valueOrDefault<Color>(
                                            detailsItemRecord.stable
                                                .colorPalettes.lightVibrant,
                                            FlutterFlowTheme.of(context).white,
                                          )
                                        : valueOrDefault<Color>(
                                            detailsItemRecord.stable
                                                .colorPalettes.darkVibrant,
                                            Colors.black,
                                          ),
                    ...
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'DETAILS_PAGE_edit_rounded_ICN_ON_TAP');
